 ...
 */
package com.nuaa.larry.wifiindoorlocation.widge.fabProgressCircle.completefab;
...
public class CompleteFABView extends FrameLayout {
  ...
  private final int RESET_DELAY = 1000;
  ...
  private void setIcon() {
    ...
    iconView.setImageDrawable(
        iconDrawable != null ? iconDrawable : getResources().getDrawable(R.drawable.done));
  }
